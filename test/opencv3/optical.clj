...
(def bw (new-mat))
(adaptive-threshold gray bw 255 Imgproc/ADAPTIVE_THRESH_GAUSSIAN_C Imgproc/THRESH_BINARY_INV 105 1)
(def kernel
  (get-structuring-element Imgproc/MORPH_ERODE (new-size 3 3)))
(dilate! bw kernel)
...
(def gray (new-mat))
(cvt-color img2 gray COLOR_RGB2GRAY)
(adaptive-threshold! gray 255 Imgproc/ADAPTIVE_THRESH_MEAN_C Imgproc/THRESH_BINARY 15 40)
(imwrite gray "output/newcat.png")
